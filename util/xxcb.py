...
for j in range(2):
    ...
    for i in range(0x08):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"RLC\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND | Processor.INS_MR | Processor.INS_MW, new Executable() {")
        print("	@Override")
    ...
    for i in range(0x08, 0x10):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"RRC\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x10, 0x18):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"RL\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x18, 0x20):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"RR\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x20, 0x28):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"SLA\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x28, 0x30):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"SRA\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x30, 0x38):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"SLL\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x38, 0x40):
        ...
        if ii == 6:
            ...
            print("    new Opcode(\"SRL\", \"(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {")
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x40, 0x80):
        ...
        if ii == 6:
            ...
            print(("    new Opcode(\"BIT\", \"%d,(" + x + "<d>)," + s + "\", 2, Processor.INS_UND, new Executable() {") % b)
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0x80, 0xc0):
        ...
        if ii == 6:
            ...
            print(("    new Opcode(\"RES\", \"%d,(" + x + "<d>)," + s + "\", 2, Processor.INS_UND | Processor.INS_MR | Processor.INS_MW, new Executable() {") % b)
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
    ...
    for i in range(0xc0, 0x100):
        ...
        if ii == 6:
            ...
            print(("    new Opcode(\"SET\", \"%d,(" + x + "<d>)," + s + "\", 2, Processor.INS_UND | Processor.INS_MR | Processor.INS_MW, new Executable() {") % b)
        print("	@Override")
        print("	public int exec() {")
        print("	  incPC();")
        print("	  WZ = " + x + " + ((byte)memory.getByte(PC));")
