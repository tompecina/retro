...
public class ComputerHardware {
  ...
  public ComputerHardware() {
    ...
    final Inverter inverter = new Inverter("TapeRecorderInverter");
    ...
    new IONode().add(tapeRecorderHardware.getOutPin()).add(inverter.getInPin());
    new IONode().add(systemPPI.getPin(23)).add(inverter.getOutPin());
