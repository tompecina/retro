 ...
 * @version @VERSION@
 */
public class ColorLEDMatrixPanel extends BackgroundFixedPane {

  // static logger
  private static final Logger log =
    Logger.getLogger(ColorLEDMatrixPanel.class.getName());
   ...
   */
  public ColorLEDMatrixPanel(final ColorLEDMatrixHardware hardware) {
    super("ledmatrix/LEDMatrixPanel/mask", "plastic", "darkgray");
    assert hardware != null;

    // set up the LED matrix
    hardware.getColorLEDMatrixElement().place(this, LED_OFFSET_X, LED_OFFSET_Y);

    log.fine("Color LED matrix panel set up");
  }
}
