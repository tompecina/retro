...
public class SettingsPanel extends JPanel {
  ...
  private SettingsVersionPanel versionPanel;
  ...
  public SettingsPanel(final HidingFrame frame,
    ...
    versionPanel = new SettingsVersionPanel(computer);
    tempPanel = new JPanel(new BorderLayout());
    tempPanel.add(versionPanel, BorderLayout.PAGE_START);
    tabbedPanel.addTab(Application.getString(this, "settings.version"),
		       tempPanel);
    ...
    setButton.addActionListener(versionPanel.createSetListener());
